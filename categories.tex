...
\index{classical!FanChouLun@范畴论}%
\begin{enumerate}
...
We assume the reader has some basic familiarity with classical category theory.\index{classical!FanChouLun@范畴论}
...
There has been a good deal of general theory developed for $\dagger$-cat\-e\-gor\-ies under classical\index{mathematics!classical}\index{classical!FanChouLun@范畴论} foundations.
...
One would have to be similarly careful in classical\index{mathematics!classical}\index{classical!FanChouLun@范畴论} category theory if one wanted to avoid the axiom of choice: any time we want to define a function, we need to characterize its values uniquely somehow.
...
In classical\index{mathematics!classical}\index{classical!FanChouLun@范畴论} category theory, all one can say is that this object is specified up to unique isomorphism, but in set-theoretic foundations this is not a sufficient amount of uniqueness to give us a function without invoking \choice{}.
...
\indexsee{RezkWanBei@Rezk完备}{completion, Rezk}%
...
\index{complete!SegalKongJian@Segal空间}%
\index{Segal!space}%
