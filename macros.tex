...
\newcommand{\sectionExercises}[1]{\ifdef{\OPTexerciseperpage}{\newpage}{}\phantomsection\section*{练习}\addcontentsline{toc}{section}{练习}\markright{\textsc{\@chapapp{} \thechapter{} 练习}}}
\makeatother
...
\crefformat{cha}{Appendix~#2#1#3}
\Crefformat{cha}{Appendix~#2#1#3}
\crefrangeformat{cha}{Appendices~#3#1#4--#5#2#6}
\Crefrangeformat{cha}{Appendices~#3#1#4--#5#2#6}
\crefmultiformat{cha}{Appendices~#2#1#3}{ and~#2#1#3}{, #2#1#3}{ and~#2#1#3}
\Crefmultiformat{cha}{Appendices~#2#1#3}{ and~#2#1#3}{, #2#1#3}{ and~#2#1#3}
\crefrangemultiformat{cha}{Appendices~#3#1#4--#5#2#6}{ and~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ and~#3#1#4--#5#2#6}
\Crefrangemultiformat{cha}{Appendices~#3#1#4--#5#2#6}{ and~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ and~#3#1#4--#5#2#6}
