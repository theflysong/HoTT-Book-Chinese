...
\index{HanShu@函数!bi-invertible|(defstyle}%
...
\index{HanShu@函数!contractible|(defstyle}%
\index{contractible!HanShu@函数|(defstyle}%
...
\index{HanShu@函数!contractible|)}%
\index{contractible!HanShu@函数|)}%
...
\indexdef{bijection}%
\indexsee{HanShu@函数!bijective}{bijection}%
