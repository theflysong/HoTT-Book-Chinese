...
\end{defn}
\indexsee{connected!HanShu@函数}{function, $n$-connected}
...
\indexdef{connected!LeiXing@类型}%
\indexdef{LeiXing@类型!connected}%
...
\begin{ex}\label{ex:categorical-connectedness}
  ...
  \indexdef{connected!FanChouDi@范畴地} if for every types $B, C$ the canonical map
