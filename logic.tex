...
\indexsee{LeiXing@类型!bracket}{truncation, propositional}%
...
\index{LeiXing@类型!contractible|(defstyle}%
\index{contractible!LeiXing@类型|(defstyle}%
...
\index{LeiXing@类型!contractible|)}%
\index{contractible!LeiXing@类型|)}%
